...
def home(request):
    ...
    sum_work_progress = sum(work_progress.achievement)
    work_orders = WorkOrder.objects.all()
    return render(request, 'home/dashboard.html', {'work_logs': work_logs, 'work_orders': work_orders, 'sum_work_progress': sum_work_progress })