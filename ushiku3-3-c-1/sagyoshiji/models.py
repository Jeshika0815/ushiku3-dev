...
class WorkOrder(models.Model):
    ...
    process_pattern = models.CharField("製造工程パタン", max_length=10, choices=p_pettern)  # 英数字10文字
    manager = models.CharField("製造管理担当者", max_length=16)  # 漢字16文字
    work_group = models.CharField('製作グループ', max_length=10, default=0, choices=work_groups) # 漢字10文字
    ...
    work_type = models.CharField('FB・PL', max_length=2, default=0, choices=work_sp_choices)
    work_range = models.CharField('作業範囲', max_length=200, default="P0〜0 .工0~0")
