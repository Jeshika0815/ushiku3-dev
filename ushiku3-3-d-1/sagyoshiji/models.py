...
class WorkOrder(models.Model):
    ...
    work_group = models.CharField('製作グループ', max_length=10, choices=work_groups) # 漢字10文字
    ...
    work_type = models.CharField('FB・PL', max_length=2, choices=work_sp_choices)
    work_range = models.CharField('作業範囲', max_length=200, default="ページ")
